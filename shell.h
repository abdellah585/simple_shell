...
/* err_strfunc.c */
void _eputinputstr(char *);
int _eputinputchar(char);
...
/* bin_emu.c */
int _althistory(info_t *);
int _altalias(info_t *);
...
/* env.c module */
char *_altgetenv(info_t *, const char *);
int _altenv(info_t *);
int _altsetenv(info_t *);
int _altunsetenv(info_t *);
int pop_env_list(info_t *);

/* env2.c module */
char **get_environ(info_t *);
int _funsetenv(info_t *, char *);
int _fsetenv(info_t *, char *, char *);

/* io_func.c */
char *get_hist_f(info_t *info);
int write_hist(info_t *info);
int read_hist(info_t *info);
int build_hist_l(info_t *info, char *buf, int linecount);
